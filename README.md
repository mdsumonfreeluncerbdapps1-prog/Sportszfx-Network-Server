BDApps Cricket Live Score SMS Server

A Node.js based SMS service for BDApps that provides live cricket match updates through SMS menus.
...
https://yourdomain.com/sms_listener
